...
let secretUsername = ("jvr");
let secretPassword = ("poo");
...
button.addEventListener("click", function() {
    ...
    else if (username === 'jvr' && password !== 'poo')
        {
        document.querySelector('message').innerHTML = 'wrong psw'
        }

    else if (username !== 'jvr' && password === 'poo')
    {
    document.querySelector('message').innerHTML = 'wrong user'
    }

    else if (username === '' && password === '') {document.querySelector('message').innerHTML = 'enter something'}

    else {document.querySelector('message').innerHTML = 'wrong user and wrong psw'}
